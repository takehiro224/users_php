            ...
            <form action="input.php" method="POST">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>社員名カナ</td>
                            <td><input type="text" name="name_kana" value="<?php echo htmlspecialchars($name_kana); ?>" /></td>
                        </tr>
                        <tr>
                            <td>生年月日</td>
                            ...
                            <td>
                                <select name="organization">
                                    <?php foreach(ORGANIZATION_LISTS as $value) { ?>
                                        <option value="<?php echo $value; ?>" <?php echo $organization === $value ? "selected" : ""; ?>><?php echo $value; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                            ...
                            <td>
                                <select name="post">
                                    <?php foreach(POST_LISTS as $value) { ?>
                                        <option value="<?php echo $value?>" <?php echo $post === $value ? "selected" : ""; ?>><?php echo $value; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>メールアドレス</td>
                            <td>
                                <input type="text" name="mail_address" value="<?php echo htmlspecialchars($mailAddress); ?>" />
                            </td>
                        </tr>
                    </tbody>
                </table>
